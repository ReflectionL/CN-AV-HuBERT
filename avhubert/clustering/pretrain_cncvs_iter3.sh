...
for rank in $(seq 0 3); do
    cat ${label_dir}iter2_L12/train_${rank}_4.km
done > ${label_dir}iter2_L12/train.km
# for rank in $(seq 0 3); do
#     cat ${label_dir}iter2_L12/valid_${rank}_4.km
# done > ${label_dir}iter2_L12/valid.km
# for rank in $(seq 0 3); do
#     cat ${label_dir}iter2_L12/test_${rank}_4.km
# done > ${label_dir}iter2_L12/test.km

## generate dict.km.txt
# for i in $(seq 0 499);do
#     echo $i 10000
# done > ${label_dir}/iter2_L12/dict.km.txt
